...
export function HeroContent() {
  return (
    <div className="mx-auto max-w-2xl text-center">
      <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-atrium-yellow/95 opacity-0 animate-fade-in-up animate-delay-100 fill-mode-forwards">
      ...
      <h1 className="mb-6 text-4xl font-bold leading-tight text-white opacity-0 animate-fade-in-up animate-delay-200 fill-mode-forwards sm:text-5xl lg:text-6xl">
        Welcome to <span className="text-atrium-yellow">Atrium Health</span>
      </h1>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 opacity-0 animate-fade-in-up animate-delay-500 fill-mode-forwards">
        <Link
          href="/auth/login"
          className="inline-flex h-12 items-center rounded-xl bg-atrium-yellow px-8 text-base font-semibold text-slate-900 shadow-lg shadow-black/20 transition-all duration-300 hover:scale-105 hover:bg-atrium-yellow/90 hover:shadow-xl hover:shadow-black/25"
        >
          Access MyAtriumHealth
        </Link>
        <Link
          href="/auth/sign-up"
