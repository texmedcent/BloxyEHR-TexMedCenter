            ...
            <div className="space-y-2">
              {notes.slice(0, 10).map((note) => (
                <button
                  type="button"
                  key={note.id}
                  className="w-full rounded border border-slate-200 px-3 py-2 text-left transition-colors hover:border-[#1a4d8c]/40 hover:bg-slate-50"
                ...
                >
                  ...
                  <p className="mt-1 text-[11px] font-medium text-[#1a4d8c]">
